...
ln -s ~/git/rdconfig/.config/lxc ~/.config/lxc
ln -s ~/git/rdconfig/.config/mpd ~/.config/mpd
ln -s ~/git/rdconfig/.config/mpv ~/.config/mpv
ln -s ~/git/rdconfig/.config/mutt ~/.config/mutt
ln -s ~/git/rdconfig/.config/ncmpcpp ~/.config/ncmpcpp
...
ln -s ~/git/rdconfig/.profile ~/.profile
ln -s ~/git/rdconfig/.zprofile ~/.zprofile
